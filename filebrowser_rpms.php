...
$path = $_GET["fs_path"];
print "<pre>";
//rpms_file_message = "<span id='select_rpms_message'>Select the rpms file :</span>";
$chkbx_str="<input type='radio' name='output_rpms' value=";
$chkbx_str_1=" \"/>";
//$path = "/data/";
...
//list_fs($path);
print "<script type='text/javascript' src='js/select_rpms_radio.js'></script>";
